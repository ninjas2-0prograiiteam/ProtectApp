            ...
            throws ServletException, IOException 
    {
        ...
        try (PrintWriter out = response.getWriter()) 
        {
            ...
            if(strFormId.equals("1"))
            {
                ...
                int iRows = CLogic.NuevoPagoRows(iIdUsuario, strNodeTarjeta, iCvv, iFechadeVencimiento);
            ...
            if(strFormId.equals("3"))
            {
                ...
                request.getSession().setAttribute("pagos", CPago);
            ...
            if(strFormId.equals("4"))
            {
                ...
                PagoLogic CLogic = new PagoLogic();
                int iRows = CLogic.updatePagoRows(iId, iIdUsuario, strNodeTarjeta, iCvv, iFechadeVencimiento) ;
            ...
            {
                PagoLogic CLogic = new PagoLogic();
                ArrayList<PagoObj> CArray = CLogic.getAllPagos(strUsername);
            ...
            if(strFormId.equals("6"))
            {
                ...
                UsuariosObj CUsuariosArray = CUsuariosLogic.getUsersByUsername(strUser);
