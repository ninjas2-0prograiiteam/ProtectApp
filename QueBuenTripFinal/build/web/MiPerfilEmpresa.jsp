    ...
    <body>
        ...
        <form id="myform" name="myform" action="EmpresaServlet" method="get">
            ...
            <br><br><br>
             ...
             <a href="EmpresaServlet?formid=4&id=<%= CEmpresa.getId() %>" class="boton info" style="text-decoration:none;">
                           Actualizar datos
                        </a>
                           <br><br><br>
               <a href="EmpresaServlet?formid=3&id=<%= CEmpresa.getId() %>" class="boton danger" style="text-decoration:none;">
                           Eliminar cuenta
                        </a>
                            <input type="hidden" id="id" name="id" value="<%= CEmpresa.getId() %>" /> <br><br>
