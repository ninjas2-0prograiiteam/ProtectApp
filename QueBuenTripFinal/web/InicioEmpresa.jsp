...
<html>
    ...
    <body>
        ...
        <div class="navbar">  
          ...
          <a href="EventoServlet?formid=6">Publicar Evento</a> 
          <a href="EmpresaServlet?formid=7&usuario=<%= usuario %>">Mis Eventos</a>   
          <div class="dropdown">
  ...
  <a href="EmpresaServlet?formid=8&usuario=<%= usuario %>"><i class="fa fa-fw fa-user"></i>Mi perfil</a>
  <a href="EmpresaServlet?formid=6&usuario=<%= usuario %>"><i class="fa fa-fw fa-wrench"></i>Configuración</a>
