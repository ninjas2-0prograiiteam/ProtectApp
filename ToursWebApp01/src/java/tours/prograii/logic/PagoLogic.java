...
public class PagoLogic extends Logic
{
    ...
    public int NuevoPagoRows(int p_iIdUsuario, int p_iNodeTarjeta, int p_iCvv, int p_iFechadeVencimiento)
    {
        DatabaseX database = getDatabase();
    ...
    public int updatePagoRows(int p_iId, int p_iIdUsuario, int p_iNodeTarjeta, int p_iCvv, int p_iFechadeVencimiento) 
    {
        ...
        String strSql = "update tourdatabase.pago "
                ...
                + "nodetarjeta = "+p_iNodeTarjeta+", cvv = "+p_iCvv+", fechadevencimiento = "+p_iFechadeVencimiento+" "
                + "where id = "+p_iId+" ";
