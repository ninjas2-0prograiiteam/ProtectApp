            ...
            throws ServletException, IOException 
    {
        ...
        try (PrintWriter out = response.getWriter()) 
        {
            ...
            if(strFormId.equals("1"))
            {
                ...
                int iRows = CLogic.insertEmpresaRows(strNombre, strEmail, iTelefono, iNit, strUsername, strPassword, iNodecuenta);
         ...
         /*   if(strFormId.equals("2"))
            ...
            if(strFormId.equals("3"))
            {
                ...
                //access logic
                EmpresaLogic CLogic = new EmpresaLogic();
                int iRows = CLogic.deleteEmpresaRows(iId);
            ...
            if(strFormId.equals("4"))
            {
                ...
                //access logic
                EmpresaLogic CLogic = new EmpresaLogic();
                EmpresaObj CCountry = CLogic.getCountryById(iId);
